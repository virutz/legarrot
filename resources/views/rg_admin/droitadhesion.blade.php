                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover dataTables-example" >
                          ...
                          <tbody>
                          @php $cpt = 1; @endphp
						@foreach ($cotisationadhs as $cotisationadh)
                                <tr>                                     
                                 <td class="hidden-480" align="center">{{ $cotisationadh->cotisationadhExercice->name }}</td>
                                  <td class="hidden-480" align="center">{{ $cotisationadh->name }}</td>
                                  <td class="hidden-480" align="center">
                                    
                                  @if($cotisationadh->status == 1)
                                    ...
                                    @endif
                                    &nbsp;
                                    <a title="Modifier Données" data-toggle="modal" data-target="#myModalcotisationadhupdate{{ $cotisationadh->id }}"><button class="btn btn-default">
                                    <span class="ace-icon fa fa-pencil"></span>
                                    </button></a>

                                    
                                    <div class="modal inmodal" id="myModalcotisationadhupdate{{ $cotisationadh->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                            ...
                                            <div class="modal-content animated bounceInRight">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Modification</h4>
                                                        ...
                                                        <form action="{{ route('droitadhesionupdate', $cotisationadh->id) }}" method="GET"  name="cotisationadhupdate"  class="well form-horizontal" >
                                                    @csrf 
												    @method('PUT')
                                                        
                                                        <div class="form-group"><font color="white"><b>*</b></font>&nbsp;<label>Année Exercice</label>
                                                       
                                                        <input name="exercice_id" value="{{ $cotisationadh->cotisationadhExercice->name }}" class="form-control" minlength="4" maxlength="11" readonly="readonly">
                                                        </div>

                                                        <div class="form-group"><font color="red"><b>*</b></font>&nbsp;<label>Montant Droit Adhésion (F)</label>
                                                        <input name="name" value="{{ $cotisationadh->name }}" class="form-control" minlength="4" maxlength="11" onKeyUp="verif_integer(this)" required="required">
                                                        </div>
													...
													<input type="hidden" name="hidden_id" value="{{ $cotisationadh->id }}" />
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <form action="{{ route('droitadhesionadd') }}" method="GET"  name="form_cotisationadhadd" class="well form-horizontal" >
