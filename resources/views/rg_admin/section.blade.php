                                ...
                                <table class="table table-hover dataTables-example" >
                                  ...
                                  @php $cpt = 1; @endphp
                                    ...
                                    <tr>                                     
                                      ...
                                      <td class="hidden-480" align="center">[ {{ $section->nameabrv }}  ]</td>
									  <td class="hidden-480">{{ $section->sectionRegion->name }}</td>
                                      <td class="hidden-480" align="center">{{ $section->phone1 }}</td>
                                      <td class="hidden-480" align="center">{{ $section->phone2 }}</td>
                                      <td class="hidden-480" align="center">
										...
										&nbsp;
											...
											<a title="Modifier Données" data-toggle="modal" data-target="#myModalsectionupdate{{ $section->id }}"><button class="btn btn-default">
											<span class="ace-icon fa fa-pencil"></span>
											</button></a>

											
											<div class="modal inmodal" id="myModalsectionupdate{{ $section->id }}" tabindex="-1" role="dialog" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content animated bounceInRight">
														<div class="modal-header">
															...
															<form action="{{ route('sectionupdate', $section->id) }}" method="GET"  name="form_sectionupdate" class="well form-horizontal" >
															@csrf 
															@method('PUT')
																...
																<option value="{{ $section->sectionRegion->id }}">{{ $section->sectionRegion->name }}</option>
																...
																<input  name="name" class="form-control" minlength="3" value="{{ $section->name }}"  onChange="javascript:this.value=this.value.toUpperCase();" required="required" value="" title="Ne doit pas contenir d'apostrophe et autres caratères accentués" >
																</div>

																<div class="form-group"><font color="red"><b>*</b></font>&nbsp;<label>Code</label>
																<input  name="nameabrv" class="form-control" maxlength="3" value="{{ $section->nameabrv }}"  onChange="javascript:this.value=this.value.toUpperCase();" required="required" value="" title="Ne doit pas contenir d'apostrophe et autres caratères accentués" >
																</div>

																<div class="form-group"><font color="red"><b>*</b></font>&nbsp;<label>Contact #1</label>
																<input  name="phone1" class="form-control" minlength="3" value="{{ $section->phone1 }}"  pattern="[0-9]{13}" value="" onKeyUp="verif_integer(this)" required="required">
																</div>

																<div class="form-group"><font color="red"><b>*</b></font>&nbsp;<label>Contact #2</label>
																<input  name="phone2" class="form-control" minlength="3" value="{{ $section->phone2 }}"  pattern="[0-9]{13}" value="" onKeyUp="verif_integer(this)" required="required">
																</div>
